...
features:
  ...
  - icon: "📊"
    ...
    description: "Overzicht van bereik, engagement en groei — zodat je ziet wat Sarah oplevert."
...
visual: |
  <div style="background: var(--surface); border-radius: 16px; border: 1.5px solid var(--border); padding: 24px; display: flex; flex-direction: column; gap: 16px;">
    <div style="font-family: var(--font-mono); font-size: 0.75rem; color: var(--muted); text-transform: uppercase; letter-spacing: 0.05em;">📣 Sarah — Content kalender</div>
    <div style="display: flex; flex-direction: column; gap: 8px;">
      <div style="background: var(--hl-pink-bg); border: 1.5px solid var(--hl-pink); border-radius: 10px; padding: 12px 14px;">
        <div style="font-family: var(--font-mono); font-size: 0.7rem; color: var(--muted); margin-bottom: 4px;">Ma 17 mrt — LinkedIn</div>
      ...
      <div style="background: var(--bg); border: 1px solid var(--border); border-radius: 10px; padding: 12px 14px; opacity: 0.5;">
        <div style="font-family: var(--font-mono); font-size: 0.7rem; color: var(--muted); margin-bottom: 4px;">Di 25 mrt — LinkedIn (gepland)</div>
        <div style="font-size: 0.82rem; color: var(--text-mid);">Sarah werkt aan de post...</div>
      </div>
    </div>
    <div style="display: flex; gap: 8px; margin-top: 4px;">
      <div style="flex: 1; background: var(--border-soft); border-radius: 8px; padding: 12px; text-align: center;">
        <div style="font-size: 1.3rem; font-weight: 800; color: var(--text);">8</div>
        <div style="font-size: 0.75rem; color: var(--muted);">Posts / maand</div>
      </div>
      <div style="flex: 1; background: var(--border-soft); border-radius: 8px; padding: 12px; text-align: center;">
        <div style="font-size: 1.3rem; font-weight: 800; color: var(--text);">+340%</div>
        <div style="font-size: 0.75rem; color: var(--muted);">Gem. bereik</div>
      </div>
    </div>
  </div>
---

## Waarom consistentie wint op social media

Op social media gaat het niet om de perfecte post. Het gaat om aanwezig zijn — elke week, elke maand.

De meeste bedrijven starten enthousiast, plaatsen een paar weken content en stoppen dan. Omdat het te veel tijd kost. Omdat er altijd iets urgenter is.

Sarah lost dat op. Zij stopt niet.
...
- Wat je WEL en NIET op social media wil delen
- Lopende projecten of nieuws dat Sarah kan verwerken in posts

Daarna schrijft Sarah haar eerste posts — en jij geeft goedkeuring voordat er iets live gaat. Zo bouwen we vertrouwen op.
